    ...
    <View style={styles.container}>
      ...
      <View style={[styles.buttonRow, {marginTop: 30}]}>
        <TouchableOpacity
          ...
          onPress={() => {
            addPoint();
            navigation.navigate('CountdownDBIncline313');
          }}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            addPoint();
            navigation.navigate('CountdownDBIncline335');
          }}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            addPoint();
            navigation.navigate('CountdownDBIncline358');
          }}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            addPoint();
            navigation.navigate('CountdownDBIncline38');
          }}>
      ...
      <View style={styles.buttonRowClose}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('PecFlyScreen')}
        >
...
export default DBInclineScreen3;
