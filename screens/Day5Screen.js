  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#fff' }}>
      ...
      <View style={{
        ...
        <ImageBackground 
            source={require('../screens/5BG.webp')} 
            style={{
              height: '100%', 
              width: '100%', 
        }}
      ...
      <View style={styles.curvedBox}>
          ...
          <View style={styles.boxSection}>
            ...
            <View>
              ...
              <Text style={[styles.boxText, styles.pbold]}>210kcal</Text>
            </View>
          </View>
        </View>
        ...
        <View style={{ marginTop: screenHeight * 0.01}}>
          <Text style={{ fontSize: 18, fontFamily: 'PBold', marginBottom: 10 }}>  Shoulders & Arms Workout</Text>
        </View>

        <View style={styles.additionalTextContainer}>
        <Text style={styles.descriptionTitle}>Description:</Text>
        <Text style={styles.additionalText}>This workout focuses the front , lateral and rear delts of the shoulders and partly the arms such as the biceps and triceps. More specifically, the long, lateral and medial heads of the triceps and the short and long head of the biceps. This workout are designed to enhance strength and hypotrophy of the shoulders and arms..</Text>
        </View>
       ...
       {/*box with an image */}
        ...
        <View style={styles.dayBox}>
          ...
          <View style={{ flex: 1, flexDirection: 'column' }}>
          <Text style={styles.dayText}>Front Raises</Text>
        ...
        <View style={styles.dayBox}>
          ...
          <View style={{ flex: 1, flexDirection: 'column' }}>
          <Text style={styles.dayText}>Bicep Curls</Text>
