...
const CountdownTricepPushdown335 = () => {
  ...
  useEffect(() => {
    ...
    if (countdownStarted && seconds > 0) {
      ...
      navigation.navigate('OverheadExtensionScreen'); // Navigate when countdown finishes
    ...
    <View style={styles.container}>
      {firstOverlayVisible && (
        <TouchableOpacity style={styles.overlay} onPress={handleFirstOverlayTap}>
          <Image source={require("../screens/screenimages/SoCloseAsh.png")} style={styles.overlayImage} />
        </TouchableOpacity>
      )}
      ...
      {countdownStarted && (
        <>
          ...
          <View style={styles.buttonsContainer}>
            ...
            <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('OverheadExtensionScreen')}>
...
export default CountdownTricepPushdown335;
