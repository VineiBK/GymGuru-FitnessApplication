...
const CountdownTricepPushdown3812 = () => {
    ...
    <View style={styles.container}>
      {firstOverlayVisible && (
        <TouchableOpacity style={styles.overlay} onPress={handleFirstOverlayTap}>
          <Image source={require("../screens/screenimages/WowAash.png")} style={styles.overlayImage} />
        </TouchableOpacity>
      )}
...
export default CountdownTricepPushdown3812;
