  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#fff' }}>
      ...
      <View style={{
        ...
        <ImageBackground 
            source={require('../screens/6BG.webp')} 
            style={{
              height: '100%', 
              width: '100%', 
        }}
      ...
      <View style={styles.curvedBox}>
          ...
          <View style={styles.boxSection}>
            ...
            <View>
              ...
              <Text style={[styles.boxText, styles.pbold]}>1hr 20mins</Text>
            </View>
          </View>
          ...
          <View style={styles.boxSection}>
            ...
            <View>
              ...
              <Text style={[styles.boxText, styles.pbold]}>450kcal</Text>
            </View>
          </View>
        </View>
        ...
        <View style={{ marginTop: screenHeight * 0.01}}>
          <Text style={{ fontSize: 18, fontFamily: 'PBold', marginBottom: 10 }}>  Legs Workout</Text>
        </View>

        <View style={styles.additionalTextContainer}>
        <Text style={styles.descriptionTitle}>Description:</Text>
        <Text style={styles.additionalText}>This workout focuses on the leg muscles specifically the quads, hamstrings and the calves. This workout are designed to enhance strength and growth of the legs..</Text>
        </View>
       ...
       {/*box with an image */}
        <View style={styles.dayBox}>
          <View style={styles.imageBox}>
            <Image source={require('../screens/gifs/SquatGif.gif')} style={styles.imageStyle} />
          </View>
          <View style={{ flex: 1, flexDirection: 'column' }}>
          <Text style={styles.dayText}>Squats</Text>
        ...
        <View style={styles.dayBox}>
          <View style={styles.imageBox}>
            <Image source={require('../screens/gifs/RDLGif.gif')} style={styles.imageStyle} />
          </View>
          <View style={{ flex: 1, flexDirection: 'column' }}>
          <Text style={styles.dayText}>RDLs</Text>
        ...
        <View style={styles.dayBox}>
          <View style={styles.imageBox}>
            <Image source={require('../screens/gifs/LegPressGif.gif')} style={styles.imageStyle} />
          </View>
          <View style={{ flex: 1, flexDirection: 'column' }}>
          <Text style={styles.dayText}>Leg Press</Text>
        ...
        <View style={styles.dayBox}>
          <View style={styles.imageBox}>
            <Image source={require('../screens/gifs/CalvesGif.gif')} style={styles.imageStyle} />
          </View>
          <View style={{ flex: 1, flexDirection: 'column' }}>
          <Text style={styles.dayText}>Calf Raises</Text>
          <Text style={styles.subText}> 3 Sets x 12 Reps </Text>
          </View>
          <Ionicons name="chevron-down" size={24} color="black" />
        </View>
