    ...
    <View style={styles.container}>
      ...
      <View style={[styles.buttonRow, {marginTop: 30}]}>
        <TouchableOpacity
          ...
          onPress={() => {
            addPoint();
            navigation.navigate('CountdownBench213');
          }}>
        ...
        <TouchableOpacity
         ...
         onPress={() => {
           addPoint();
           navigation.navigate('CountdownBench235');
         }}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            addPoint();
            navigation.navigate('CountdownBench258');
          }}>
        ...
        <TouchableOpacity
         ...
         onPress={() => {
           addPoint();
           navigation.navigate('CountdownBench28');
         }}>
      ...
      <View style={styles.buttonRowClose}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('BenchPressScreen3')}
        >
...
export default BenchPressScreen2;
