    ...
    <View style={styles.container}>
      ...
      <Modal
        ...
        <TouchableOpacity style={styles.overlay} onPress={() => setShowOverlay(false)}>
           {/* Image Overlay */}
          <Image source={require("../screens/screenimages/OverheadTricepsWorkout.png")} style={styles.overlayImage} /> 
        </TouchableOpacity>
      </Modal>
      <Image
      ...
      <View style={[styles.buttonRow, {marginTop: 30}]}>
        <TouchableOpacity
          ...
          onPress={() => {
            addPoint();
            navigation.navigate('CountdownOverhead114');
          }}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            addPoint();
            navigation.navigate('CountdownOverhead148');
          }}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            addPoint();
            navigation.navigate('CountdownOverhead1812');
          }}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            addPoint();
            navigation.navigate('CountdownOverhead112');
          }}>
      ...
      <View style={styles.buttonRowClose}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('OverheadExtensionScreen2')}
        >
...
export default OverheadExtensionScreen;
