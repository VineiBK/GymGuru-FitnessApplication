    ...
    <View style={styles.container}>
      ...
      <Modal
        ...
        <TouchableOpacity style={styles.overlay} onPress={() => setShowOverlay(false)}>
           {/* Image Overlay */}
          <Image source={require("../screens/screenimages/WeightedDipsWorkout.png")} style={styles.overlayImage} /> 
        </TouchableOpacity>
      </Modal>
      <Image
        source={require("../screens/gifs/DipsGif.gif")}
        style={styles.gifStyle}
      />
      <Text style={styles.mainText}>Weighted Dips</Text>
      <Text style={styles.subText}>Set 1</Text>
      <Text style={styles.subText2}>x6-12 REPS</Text>
      ...
      <View style={[styles.buttonRow, {marginTop: 30}]}>
        <TouchableOpacity
          ...
          onPress={() => {
            addPoint();
            navigation.navigate('CountdownDip114');
          }}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            addPoint();
            navigation.navigate('CountdownDip148');
          }}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            addPoint();
            navigation.navigate('CountdownDip1812');
          }}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            addPoint();
            navigation.navigate('CountdownDip112');
          }}>
      ...
      <View style={styles.buttonRowClose}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('DipScreen2')}
        >
