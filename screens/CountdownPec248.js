...
const CountdownPec248 = () => {
  ...
  useEffect(() => {
    ...
    if (countdownStarted && seconds > 0) {
      ...
      navigation.navigate('PecFlyScreen3'); // Navigate when countdown finishes
      ...
      {countdownStarted && (
        <>
          ...
          <View style={styles.buttonsContainer}>
            ...
            <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('PecFlyScreen3')}>
...
export default CountdownPec248;
