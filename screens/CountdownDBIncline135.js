...
const CountdownDBIncline135 = () => {
  ...
  useEffect(() => {
    ...
    if (countdownStarted && seconds > 0) {
      ...
      navigation.navigate('DBInclineScreen2'); // Navigate when countdown finishes
      ...
      {countdownStarted && (
        <>
          ...
          <View style={styles.buttonsContainer}>
            ...
            <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('DBInclineScreen2')}>
...
export default CountdownDBIncline135;
