...
const OverheadExtensionScreen3 = () => {
    ...
    <View style={styles.container}>
      ...
      <View style={[styles.buttonRow, {marginTop: 30}]}>
        <TouchableOpacity
          ...
          onPress={() => {
            addPoint();
            navigation.navigate('CompletedDay1WorkoutScreen');
          }}>
      ...
      <View style={styles.buttonRowClose}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('CompletedDay1WorkoutScreen')}
        >
...
export default OverheadExtensionScreen3;
