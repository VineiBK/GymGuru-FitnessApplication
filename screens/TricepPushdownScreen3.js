...
const TricepPushdownScreen3 = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subText}> FINAL SET - Set 3</Text>
      ...
      <View style={[styles.buttonRow, {marginTop: 30}]}>
        <TouchableOpacity
          ...
          onPress={() => {
            addPoint();
            navigation.navigate('CountdownTricepPushdown313');
          }}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            addPoint();
            navigation.navigate('CountdownTricepPushdown335');
          }}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            addPoint();
            navigation.navigate('CountdownTricepPushdown358');
          }}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            addPoint();
            navigation.navigate('CountdownTricepPushdown3812');
          }}>
      ...
      <View style={styles.buttonRowClose}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('OverheadExtensionScreen')}
        >
...
export default TricepPushdownScreen3;
