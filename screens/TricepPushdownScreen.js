    ...
    <View style={styles.container}>
      ...
      <Modal
        ...
        <TouchableOpacity style={styles.overlay} onPress={() => setShowOverlay(false)}>
           {/* Image Overlay */}
          <Image source={require("../screens/screenimages/TricepPushdownWorkout.png")} style={styles.overlayImage} /> 
        </TouchableOpacity>
      </Modal>
      <Image
        source={require("../screens/gifs/TriceppushdownGif.jpg")}
        style={styles.gifStyle}
      />
      <Text style={styles.mainText}>Tricep Pushdown</Text>
      <Text style={styles.subText}>Set 1</Text>
      ...
      <View style={[styles.buttonRow, {marginTop: 30}]}>
        <TouchableOpacity
          ...
          onPress={() => {
            addPoint();
            navigation.navigate('CountdownTricepPushdown113');
          }}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            addPoint();
            navigation.navigate('CountdownTricepPushdown135');
          }}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            addPoint();
            navigation.navigate('CountdownTricepPushdown158');
          }}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            addPoint();
            navigation.navigate('CountdownTricepPushdown1812');
          }}>
      ...
      <View style={styles.buttonRowClose}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('TricepPushdownScreen2')}
        >
...
export default TricepPushdownScreen;
