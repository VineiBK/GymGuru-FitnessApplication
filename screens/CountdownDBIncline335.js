...
const CountdownDBIncline335 = () => {
  ...
  useEffect(() => {
    ...
    if (countdownStarted && seconds > 0) {
      ...
      navigation.navigate('PecFlyScreen'); // Navigate when countdown finishes
      ...
      {countdownStarted && (
        <>
          ...
          <View style={styles.buttonsContainer}>
            ...
            <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('PecFlyScreen')}>
...
export default CountdownDBIncline335;
