...
const CountdownTricepPushdown235 = () => {
  ...
  useEffect(() => {
    ...
    if (countdownStarted && seconds > 0) {
      ...
      navigation.navigate('TricepPushdownScreen3'); // Navigate when countdown finishes
      ...
      {countdownStarted && (
        <>
          ...
          <View style={styles.buttonsContainer}>
            ...
            <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('TricepPushdownScreen3')}>
...
export default CountdownTricepPushdown235;
