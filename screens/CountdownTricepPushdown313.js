...
const CountdownTricepPushdown313 = () => {
    ...
    <View style={styles.container}>
      {firstOverlayVisible && (
        <TouchableOpacity style={styles.overlay} onPress={handleFirstOverlayTap}>
          <Image source={require("../screens/screenimages/SadAsh.png")} style={styles.overlayImage} />
        </TouchableOpacity>
      )}
...
export default CountdownTricepPushdown313;
