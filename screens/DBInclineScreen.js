    ...
    <View style={styles.container}>
      ...
      <Modal
        ...
        <TouchableOpacity style={styles.overlay} onPress={() => setShowOverlay(false)}>
           {/* Image Overlay */}
          <Image source={require("../screens/screenimages/StartingDBInclineAsh.png")} style={styles.overlayImage} /> 
        </TouchableOpacity>
      </Modal>
      <Image
        source={require("../screens/gifs/InclineDBpressGif.gif")}
        style={styles.gifStyle}
      />
      <Text style={styles.mainText}>DB Incline Press</Text>
      ...
      <View style={[styles.buttonRow, {marginTop: 30}]}>
        <TouchableOpacity
          ...
          onPress={() => {
            addPoint();
            navigation.navigate('CountdownDBIncline113');
          }}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            addPoint();
            navigation.navigate('CountdownDBIncline135');
          }}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            addPoint();
            navigation.navigate('CountdownDBIncline158');
          }}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            addPoint();
            navigation.navigate('CountdownDBIncline18');
          }}>
      ...
      <View style={styles.buttonRowClose}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('DBInclineScreen2')}
        >
...
export default DBInclineScreen;
