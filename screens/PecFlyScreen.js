    ...
    <View style={styles.container}>
      ...
      <Modal
        ...
        <TouchableOpacity style={styles.overlay} onPress={() => setShowOverlay(false)}>
           {/* Image Overlay */}
          <Image source={require("../screens/screenimages/PecFlyWorkout.png")} style={styles.overlayImage} /> 
        </TouchableOpacity>
      </Modal>
      <Image
        source={require("../screens/gifs/PecflymachineGif.gif")}
        style={styles.gifStyle}
      />
      <Text style={styles.mainText}>Pec Fly Machine</Text>
      ...
      <View style={[styles.buttonRow, {marginTop: 30}]}>
        <TouchableOpacity
          ...
          onPress={() => {
            addPoint();
            navigation.navigate('CountdownPec114');
          }}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            addPoint();
            navigation.navigate('CountdownPec148');
          }}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            addPoint();
            navigation.navigate('CountdownPec1812');
          }}>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            addPoint();
            navigation.navigate('CountdownPec112');
          }}>
      ...
      <View style={styles.buttonRowClose}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('PecFlyScreen2')}
        >
