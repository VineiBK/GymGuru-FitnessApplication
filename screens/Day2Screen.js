  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#fff' }}>
      ...
      <View style={{
        ...
        <ImageBackground 
            source={require('../screens/BackDay.jpg')} 
            style={{
              height: '100%', 
              width: '100%', 
        }}
      ...
      <View style={styles.curvedBox}>
          ...
          <View style={styles.boxSection}>
            ...
            <View>
              ...
              <Text style={[styles.boxText, styles.pbold]}>1hr 30mins</Text>
            </View>
          </View>
          ...
          <View style={styles.boxSection}>
            ...
            <View>
              ...
              <Text style={[styles.boxText, styles.pbold]}>580kcal</Text>
            </View>
          </View>
        </View>
        ...
        <View style={{ marginTop: screenHeight * 0.01}}>
          <Text style={{ fontSize: 18, fontFamily: 'PBold', marginBottom: 10 }}>  Back & Biceps Workout</Text>
        </View>

        <View style={styles.additionalTextContainer}>
        <Text style={styles.descriptionTitle}>Description:</Text>
        <Text style={styles.additionalText}>This workout focuses on the back muscles particularly the mid back and both teres major and minor and most importantly, the lats. Furthermore, we incorporate both the long and short heads of the bicep and the braichallis. This workout are designed to enhance growth of the back muscles and the strength of the biceps..</Text>
        </View>
       ...
       {/*box with an image */}
        <View style={styles.dayBox}>
          <View style={styles.imageBox}>
            <Image source={require('../screens/gifs/PullUpGif.gif')} style={styles.imageStyle} />
          </View>
          <View style={{ flex: 1, flexDirection: 'column' }}>
          <Text style={styles.dayText}>Pull Ups</Text>
        ...
        <View style={styles.dayBox}>
          <View style={styles.imageBox}>
            <Image source={require('../screens/gifs/PreacherGif.gif')} style={styles.imageStyle} />
          </View>
          <View style={{ flex: 1, flexDirection: 'column' }}>
          <Text style={styles.dayText}>Barbell Bicep Curls </Text>
          <Text style={styles.subText}> 3 Sets x 8 Reps </Text>
          </View>
          <Ionicons name="chevron-down" size={24} color="black" />
        </View>
        ...
        <View style={styles.dayBox}>
          <View style={styles.imageBox}>
            <Image source={require('../screens/gifs/HammerCurlsGif.gif')} style={styles.imageStyle} />
          </View>
          <View style={{ flex: 1, flexDirection: 'column' }}>
          <Text style={styles.dayText}>Dumbbell Hammer Curls</Text>
          <Text style={styles.subText}> 3 Sets x 12 Reps </Text>
          </View>
          <Ionicons name="chevron-down" size={24} color="black" />
        </View>
